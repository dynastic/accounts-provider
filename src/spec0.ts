...
export interface AddressedEmailRequest extends EmailRequest {
    email: string;
}

export interface PayPalAPIKey {
    id: string;
    clientID: string;
    type: "sandbox" | "live";
}
...
export interface RefundRequest {
    ...
    open: boolean;
    escalatedToAdministration: boolean;
    isAdministration: boolean;
    lastResponseSender?: RefundRequestChatMessageSender;
    fields: { [label: string]: Field[] };
}

export enum RefundRequestChatMessageSender {
    Customer, Merchant, Admin, System
}

export interface RefundRequestChatMessage {
    id: string;
    date: number;
    text: string;
    sender: RefundRequestChatMessageSender;
}

/** POST /user/security/totp/setup */
